...
| **Probabilistic Machine Learning: An Introduction** | 📚 [(link)](https://github.com/probml/pml-book/releases/latest/download/book1.pdf) | 통칭 머피책. PRML에 이은 바이블. 학부생이 좀 더 보기 편하고, generative model에 대해 잘 소개함. 기존의 Machine Learning: a Probabilistic Perspective가 개정되어 Transformer 등의 최신 내용이 추가됨. |
